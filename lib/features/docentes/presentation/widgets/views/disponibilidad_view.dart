              ...
              children: [
                SwitchListTile(
                  ...
                  title: Text(
                    ...
                    style: TextStyle(
                      color:      disponible ? AppTheme.primary : Colors.red.shade400,
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () { Navigator.pop(ctx); _delete(disp.id); },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: provider.loadingDisponibilidad
          ...
          : provider.errorDisponibilidad != null && provider.disponibilidades.isEmpty
              ...
              : provider.disponibilidades.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        final color = d.disponible ? AppTheme.primary : Colors.red.shade400;
  ...
  Future<void> _save() async {
    ...
    try {
      await context.read<DocenteProvider>().createDisponibilidad(
        ...
        fechaInicioRestriccion: _fechaInicio != null ? _dateToStr(_fechaInicio!) : null,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Row(children: [
                const Expanded(
                  child: Text('Nueva disponibilidad',
              ...
              Row(children: [
                Expanded(child: _timeButton('Hora inicio', _horaInicio, () => _pickTime(true))),
                const SizedBox(width: 12),
                Expanded(child: _timeButton('Hora fin',    _horaFin,    () => _pickTime(false))),
              ]),
              const SizedBox(height: 16),
              Container(
                decoration: BoxDecoration(
                ...
                child: SwitchListTile(
                  ...
                  title: Text(
                    ...
                    style: TextStyle(
                      color:      _disponible ? AppTheme.primary : Colors.red.shade400,
                      fontWeight: FontWeight.w600,
                    ),
                  ),
                  activeColor:    AppTheme.primary,
              ...
              DropdownButtonFormField<String>(
                ...
                items: _tiposRestriccion.map((t) => DropdownMenuItem(
              ...
              if (_tipoRestriccion == 'TEMPORAL') ...[
                ...
                Row(children: [
                  Expanded(child: _DateButton(
                    label: 'Fecha inicio', date: _fechaInicio,
                    onTap: () => _pickDate(true), required: true,
                  )),
                  const SizedBox(width: 12),
                  Expanded(child: _DateButton(
                    label: 'Fecha fin', date: _fechaFin,
                    onTap: () => _pickDate(false), required: true,
                  )),
                ]),
              ],
